...
export default function VistaEstacionInfo() {
  ...
  const descripciones = [
    { icon: require("../assets/location_icon.png"), text: selectedCargador.formattedAddress || "Sin información" },
    {
    ...
    { icon: require("../assets/internet_icon.png"), text: selectedCargador.websiteUri || "Sin información" },
  ];
